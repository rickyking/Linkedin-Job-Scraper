...
class LinkedinScrap:
    ...
    def __init__(self, username, password, language, position, location, max_jobs): 
        ...
        self.browser = webdriver.Chrome(options=self.options, executable_path = self.dirpath + "/chromedriver")
    ...
    def extract_jd(self):
        ...
        while jobs_per_page < self.max_jobs:
            ...
            for job in jobs:
                ...
                try:
                    company_name = self.browser.find_element_by_class_name('jobs-details-top-card__company-url')
                ...
                try:
                    job_name = self.browser.find_element_by_class_name('jobs-details-top-card__job-title')
                ...
                try:
                    job_description = self.browser.find_element_by_xpath('//*[@id="job-details"]')
                ...
                try:
                    employement_type = self.browser.find_element_by_class_name('js-formatted-employment-status-body')
                ...
                try:
                    industry = self.browser.find_element_by_class_name('js-formatted-industries-list')
                ...
                try:
                    location = self.browser.find_element_by_class_name('jobs-details-top-card__bullet')
                ...
                try:
                    job_function = self.browser.find_element_by_class_name('js-formatted-job-functions-list')
                ...
                try:
                    experience_Level = self.browser.find_element_by_class_name('js-formatted-exp-body')
